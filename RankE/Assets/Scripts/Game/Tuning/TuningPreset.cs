    ...
    public sealed class TuningPreset
    {
        ...
        public void Apply(TuningProfile profile, DebugLoadout loadout)
        {
            ...
            if (loadout != null)
            {
                ...
                loadout.SetEnemyVisualByName(enemyVisualName);
            }
        }

        static void ApplyBuild(FighterBuild b, FighterBuildDto dto)
        {
            ...
            b.AutoAttackId = dto.autoAttackId;
