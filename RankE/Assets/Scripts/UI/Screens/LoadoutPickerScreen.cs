...
namespace RankE.UI
{
    ...
    public sealed class LoadoutPickerScreen : MonoBehaviour
    {
        ...
        GameObject root;
        Button startButton;
        readonly Text[] values = new Text[7];
        ...
        public void Init(MatchController match, Transform parent)
        {
            ...
            string[] rowNames = { "Stance", "Weapon", "Armor", "Ability 1", "Ability 2", "Ability 3", "Ability 4" };
            ...
            UiFactory.PlaceFixed((RectTransform)hint.transform, new Vector2(0.5f, 1f),
                new Vector2(0f, -730f), new Vector2(900f, 30f));
            ...
            UiFactory.PlaceFixed((RectTransform)startButton.transform, new Vector2(0.5f, 1f),
                new Vector2(0f, -800f), new Vector2(360f, 70f));
        }
        ...
        void Cycle(int row, int dir)
        {
            switch (row)
            {
                case 0: match.Loadout.CycleStance(dir); break;
                case 1: match.Loadout.CycleWeapon(dir); break;
                case 2: match.Loadout.CycleArmor(dir); break;
                default: match.Loadout.CycleAbility(row - 3, dir); break;
            }
            Refresh();
        }
        ...
        {
            var l = match.Loadout;
            values[0].text = l.StanceName;
            values[1].text = l.WeaponName;
            values[2].text = l.ArmorName;
            for (int s = 0; s < 4; s++)
                values[3 + s].text = l.AbilityName(s);
        }
