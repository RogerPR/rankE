...
namespace RankE.Sim.Tests
{
    public class DelayedAbilityTests
    {
        ...
        {
            var b = TestKit.Duel(
                TestKit.Config("A", PocContent.FallingStar()),
                TestKit.Config("B"));

            TestKit.UseAt(b, 0, 0, PocContent.FallingStarId);
            ...
            var dmg = TestKit.EventsOf(b, SimEventType.Damaged, PocContent.FallingStarId);
