...
namespace RankE.Sim.Tests
{
    public class ParryRiposteTests
    {
        ...
        public void Parry_NegatesParriableDamage()
        {
            ...
            TestKit.UseAt(b, 0, 1, PocContent.ParryId); // window ticks 0–11
        ...
        public void ParryWindow_Expires()
        {
            ...
            TestKit.UseAt(b, 0, 1, PocContent.ParryId);
            TestKit.UseAt(b, 12, 0, PocContent.SlashId); // window (12t) just closed
        ...
        {
            var b = TestKit.Duel(
                TestKit.Config("A", PocContent.Kick()),
                TestKit.Config("B", PocContent.Parry()));

            TestKit.UseAt(b, 0, 1, PocContent.ParryId);
            TestKit.UseAt(b, 1, 0, PocContent.KickId); // kick is not parriable
